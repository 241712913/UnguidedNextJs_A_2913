...
export default function DashboardPage() {
  ...
  // Buat array 7 hari terakhir, isi 0 jika tidak ada data
                ...
                <tbody>
                  {[1,2,3,4,5].map((row) => (
                    <tr key={row} className="border-b border-gray-50">
                      ...
                      <td><div className="h-4 w-52 bg-gray-100 rounded"></div></td>
                      <td><div className="h-8 w-28 bg-gray-100 rounded-full"></div></td>
                      <td><div className="h-4 w-24 bg-gray-100 rounded"></div></td>
                    </tr>
                  ))}
                </tbody>
              </table>
  ...
  return (
    <div className="bg-[#F3F5F4] min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 m-3">
        ...
        {/* GRAFIK — per tanggal, 7 hari terakhir */}
        <div className="lg:col-span-2 bg-white rounded-[28px] p-5 shadow-[0_10px_30px_rgba(0,0,0,0.04)]">
          <div className="mb-6">
              ...
              <div key={i} className="flex-1 flex flex-col items-center">
                ...
                <div
                  className={`w-full max-w-[45px] rounded-t-[20px] hover:scale-105 transition-all duration-500 ${
                    item.total > 0
                      ? "bg-gradient-to-t from-green-700 to-green-500 shadow-[0_0_20px_rgba(33,64,56,0.2)]"
                      : "bg-gray-100"
                  }`}
                  style={{
              ...
              return (
                <div key={i}>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm text-[#18352D] font-semibold">{Math.round(persen)}%</span>
                  </div>
                  <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                    <div
          ...
          <table className="w-full min-w-[700px] text-sm">
            ...
            <tbody>
              {data.terbaru.map((item: any) => (
                ...
                >
                  <td className="py-4 text-green-700 font-semibold">{item.resi}</td>
